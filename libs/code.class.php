...
class code {
    ...
    private function setText(){
        ...
        for($i=0;$i<$this->codeLen;$i++) {
            ...
            imagettftext($this->image, $size, $angle, mt_rand($space * $i, $space * max(($i * 2), 1)), 40, $this->setColor("a"), "D:/software/wampserver/www/server/mvc-test/application/static/font/simkai.ttf", $str[$i]);
        }
    }
    //设置线条
